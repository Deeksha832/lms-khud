...
const Player = () => {
  ...
  const [progressData, setProgressData] = useState({
    lectureCompleted: [], // dummy progress to avoid crashes
  });
  ...
  // dummy marking completed
  const markLectureAsCompleted = (lectureId) => {
    setProgressData((prev) => {
      if (!prev.lectureCompleted.includes(lectureId)) {
        return {
          ...prev,
  ...
  const getCourseProgress = () => {
    setProgressData({
      lectureCompleted: [], // start with empty, mark as user clicks
    });
  };
