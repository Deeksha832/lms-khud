...
import YouTube from "react-youtube"; // ✅ Import added
...
const CourseDetails = () => {
  ...
  const currency = "₹"; // ✅ Define currency (set "$" if needed)

  // dummy enroll logic (replace with backend later)
    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-10 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          {/* Educator */}
          <p className="text-sm">
            Course by <span className="text-blue-600 underline">Deeksha</span>
          </p>
          ...
          {/* Full Course Description at Bottom */}
