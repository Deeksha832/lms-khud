...
const Dashboard = () => {
  ...
  // Dummy fallback data (instead of backend)
  const dummyDashboardData = {
    enrolledStudentsData: [
      {
        student: { name: 'Richard Sanford', imageUrl: assets.profile_img },
        courseTitle: 'Build Text to Image SaaS App in React JS'
      },
      {
        student: { name: 'Enrique Murphy', imageUrl: assets.profile_img2 },
        courseTitle: 'Build Text to Image SaaS App in React JS'
      },
      {
        student: { name: 'Alison Powell', imageUrl: assets.profile_img3 },
        courseTitle: 'Build Text to Image SaaS App in React JS'
      }
    ],
    totalCourses: 5,
